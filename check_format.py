...
def joker_check_json_task_1(fn):
  check_json(fn,['RUN_ID','MANUAL','id',"WORDPLAY","LOCATION","INTERPRETATION","HORIZONTAL\/VERTICAL","MANIPULATION_TYPE","MANIPULATION_LEVEL","CULTURAL_REFERENCE","CONVENTIONAL_FORM","OFFENSIVE"])
...
def joker_check_csv_task_1(fn):
  check_csv(fn,['RUN_ID','MANUAL','id',"WORDPLAY","LOCATION","INTERPRETATION","HORIZONTAL\/VERTICAL","MANIPULATION_TYPE","MANIPULATION_LEVEL","CULTURAL_REFERENCE","CONVENTIONAL_FORM","OFFENSIVE"])
